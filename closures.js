...
var calla = callFriend();
console.log(calla("435-215-9248"));
...
/*
   ...
   *Hint: setTimeout calls a function or evaluates an expression after a specified number of milliseconds.
    ...
    //Answer Here = The function will log 0-5 * 1000 so it will count up by 1000 each time ex:1000,2000,3000,4000,5000
  ...
  completely wrong. it logged 6 seven times and then five times every time after that  //Answer Here
